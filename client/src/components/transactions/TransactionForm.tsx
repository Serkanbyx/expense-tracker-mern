...
const getInitialFormState = (transaction: Transaction | null): FormData => {
  if (transaction) {
    return {
...
const TypeToggle = ({ activeType, onChange, disabled }: TypeToggleProps) => (
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      const payload: TransactionInput = {
        type: sanitized.type as TransactionInput['type'],
